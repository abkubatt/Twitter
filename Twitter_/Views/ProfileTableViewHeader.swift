...
class ProfileTableViewHeader: UIView {
    ...
    private func configureStackButton() {
        for (_, button) in sectionStack.arrangedSubviews.enumerated() {
            ...
            button.addTarget(self, action: #selector(didTapBar(_:)), for: .touchUpInside)
        }
    }
    
    @objc private func didTapBar(_ sender: UIButton) {
    ...
    private func configureConstraints() {
        ...
        for i in 0..<tabs.count {
            ...
            let trainlingAnchor = indicator.trailingAnchor.constraint(equalTo: sectionStack.arrangedSubviews[i].trailingAnchor)
            trailingAnchors.append(trainlingAnchor)
        }
        ...
        let profileHeaderImageViewConstraints = [
            ...
            profileHeaderImageView.heightAnchor.constraint(equalToConstant: 135 )
        ]
        ...
        let userBioLabelConstraints = [
            ...
            userBioLabel.topAnchor.constraint(equalTo: userNameLabel.bottomAnchor, constant: 6)
        ]
        ...
        let joinedDateLabelConstraints = [
            joinedDataLabel.leadingAnchor.constraint(equalTo: joinDateImageView.trailingAnchor, constant: 2.5),
        ...
        let followingTextLabelConstrinsts = [
        ...
        NSLayoutConstraint.activate(followingTextLabelConstrinsts)
